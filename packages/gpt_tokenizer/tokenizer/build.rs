...
const RUST_INPUT: &str = "src/tokenizer.rs";
const DART_OUTPUT: &str = "../lib/src/gen/bridge_generated.dart";

const IOS_C_OUTPUT: &str = "../../flutter_gpt_tokenizer/ios/Classes/frb.h";
const MACOS_C_OUTPUT_DIR: &str = "../../flutter_gpt_tokenizer/macos/Classes/";
